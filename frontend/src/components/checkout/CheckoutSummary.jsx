    ...
    >
      ...
      >
        <div className="flex gap-4">
          <ShieldCheck
            size={24}
            className="text-neutral-700 shrink-0 mt-1"
          />
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500 mt-1 leading-6">
              All transactions are encrypted and securely
              processed through Razorpay. Your card details
      ...
      <div className="mt-8 rounded-2xl bg-neutral-100 p-5">
        ...
        <p className="text-sm text-neutral-500 mt-2 leading-6">
          ...
          with payments, delivery, returns, and order
          tracking.
        </p>
      </div>
    </div>
