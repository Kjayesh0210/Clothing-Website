...
function CartSummary({ subtotal, shipping, discount, total }) {
  return (
    <div className="space-y-4">
      ...
      {/* Free Shipping */}
      <div className="flex gap-4 rounded-2xl border border-green-200 bg-green-50 p-2">
      ...
      <Link
        to="/checkout"
        className="flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-black text-base font-semibold text-white transition-all duration-300 hover:-translate-y-1 hover:bg-neutral-800 active:scale-[0.98] sm:h-16 sm:text-lg"
      >
        Proceed to Checkout
        <ArrowRight size={22} />
      </Link>
